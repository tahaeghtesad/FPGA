...
xst -ifn xst.scr
move ClockGenerator_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\ClockGenerator_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc ClockGenerator_exdes.ucf ClockGenerator_exdes

echo 'Running map'
map -timing -pr b ClockGenerator_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm ClockGenerator_exdes -w routed.ncd routed.v
cd ..
